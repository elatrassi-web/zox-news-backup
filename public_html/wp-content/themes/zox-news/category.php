					...
					<div class="mvp-main-blog-body left relative">
								...
								<div id="mvp-cat-feat-wrap" class="left relative">
											...
											<div class="mvp-widget-feat2-left-cont left relative">
												...
												<div class="mvp-feat1-feat-text left relative">
													<div class="mvp-cat-date-wrap left relative">
														<span class="mvp-cd-cat left relative"><?php $category = get_the_category(); if (isset($category)) { echo esc_html( $category[0]->cat_name ); } ?></span><span class="mvp-cd-date left relative"><?php printf( esc_html__( 'il y a %s', 'zox-news' ), human_time_diff( strtotime('2 hours', (int)get_the_time('U')), current_time( 'timestamp' ) ) ); ?></span>
									...
									<div class="mvp-widget-feat2-right left relative">
										...
										<div class="mvp-widget-feat2-right-main left relative">
											...
											global $do_not_duplicate; global $post; $current_category = single_cat_title("", false); $category_id = get_cat_ID($current_category); $cat_posts = new WP_Query(array( 'cat' => $category_id, 'post__not_in'=>$do_not_duplicate, 'posts_per_page' => '2', 'ignore_sticky_posts'=> 1 )); while($cat_posts->have_posts()) : $cat_posts->the_post(); $do_not_duplicate[] = $post->ID; ?>
												<a href="<?php the_permalink(); ?>" rel="bookmark">
												...
												<?php if($i % 2 == 0): ?>
													<?php $pubId = $pubsGAM[$i/2];?>
													<div class="pub left center relative w100">
														<div id="div-gpt-ad-<?php echo $pubId; ?>" class="lazyload-rwad" data-position-desktop="<?php echo $pubId; ?>" data-position-mobile="<?php echo (100 + $pubId); ?>"></div>
													</div>
												<?php endif; ?>
												<?php $i++; ?>
												...
												<div class="mvp-blog-story-out relative">
													...
													<div class="mvp-blog-story-in">
														<div class="mvp-blog-story-text left relative">
															<div class="mvp-cat-date-wrap left relative">
																<?php if ( is_sticky() ) { ?>
																	<span class="mvp-cd-cat left relative sticky"><?php esc_html_e( 'Sticky Post', 'zox-news' ); ?></span><span class="mvp-cd-date left relative"><?php printf( esc_html__( 'il y a %s', 'zox-news' ), human_time_diff( strtotime('2 hours', (int)get_the_time('U')), current_time( 'timestamp' ) ) ); ?></span>
																<?php } else { ?>
																	<span class="mvp-cd-cat left relative"><?php $category = get_the_category(); if (isset($category)) { echo esc_html( $category[0]->cat_name ); } ?></span><span class="mvp-cd-date left relative"><?php printf( esc_html__( 'il y a %s', 'zox-news' ), human_time_diff( strtotime('2 hours', (int)get_the_time('U')), current_time( 'timestamp' ) ) ); ?></span>
																<?php } ?>
															</div><!--mvp-cat-date-wrap-->
						...
						<div class="mvp-inf-more-wrap left relative">
							<?php $mvp_infinite_scroll = get_option('mvp_infinite_scroll'); if ($mvp_infinite_scroll == "true") { if (isset($mvp_infinite_scroll)) { ?>
								<a href="#" class="mvp-inf-more-but"><?php esc_html_e( 'Plus d\'Articles', 'zox-news' ); ?></a>
							<?php } } ?>
