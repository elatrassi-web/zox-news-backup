									...
									<header id="mvp-post-head" class="left relative">
										...
										<?php $author_info = get_option('mvp_author_info'); if ($author_info == "true") { ?>
											<div class="mvp-author-info-wrap left relative">
												...
												<div class="mvp-author-info-text left relative">
													<div class="mvp-author-info-date left relative">
														<p><?php esc_html_e( 'Publié', 'zox-news' ); ?></p> <span class="mvp-post-date"><?php printf( esc_html__( 'il y a %s', 'zox-news' ), human_time_diff( strtotime('2 hours', (int)get_the_time('U')), current_time( 'timestamp' ) ) ); ?></span> <p><?php esc_html_e( 'le', 'zox-news' ); ?></p> <span class="mvp-post-date updated"><time class="post-date updated" itemprop="datePublished" datetime="<?php the_time('Y-m-d'); ?>"><?php the_time(get_option('date_format')); ?></time></span>
														<meta itemprop="dateModified" content="<?php the_modified_date('Y-m-d'); ?>"/>
													</div><!--mvp-author-info-date-->
													<div class="mvp-author-info-name left relative" itemprop="author" itemscope itemtype="https://schema.org/Person">
														<p><?php esc_html_e( 'Par', 'zox-news' ); ?></p> <span class="author-name vcard fn author" itemprop="name"><?php the_author_posts_link(); ?></span> <?php $authortwit = get_the_author_meta('twitter'); if ( ! empty ( $authortwit ) ) { ?><a href="<?php echo esc_url(the_author_meta('twitter')); ?>" class="mvp-twit-but" target="_blank"><span class="mvp-author-info-twit-but"><i class="fa fa-twitter fa-2"></i></span></a><?php } ?>
												...
												<div id="mvp-content-body-top" class="left relative">
													...
													<div id="mvp-content-bot" class="left">
														...
														<div class="mvp-post-tags">
															<span class="mvp-post-tags-header"><?php esc_html_e( 'Articles similaires:', 'zox-news' ); ?></span><span itemprop="keywords"><?php the_tags('','','') ?></span>
														</div><!--mvp-post-tags-->
																			...
																			<div class="mvp-next-cont-out left relative">
																				<div class="mvp-next-cont-in">
																					<div class="mvp-prev-next-text left relative">
																						<span class="mvp-prev-next-label left relative"><?php esc_html_e( "Suivant", 'zox-news' ); ?></span>
																						<p><?php the_title(); ?></p>
																		...
																		<div class="mvp-prev-next-cont left relative">
																			<div class="mvp-prev-cont-out right relative">
																				...
																				<div class="mvp-prev-cont-in">
																					<div class="mvp-prev-next-text left relative">
																						<span class="mvp-prev-next-label left relative"><?php esc_html_e( "Ne manquez pas", 'zox-news' ); ?></span>
																						<p><?php the_title(); ?></p>
																					</div><!--mvp-prev-next-text-->
												...
												<div class="mvp-cont-read-wrap">
													<?php $mvp_cont_read = get_option('mvp_cont_read'); if ($mvp_cont_read == "true") { ?>
														<div class="mvp-cont-read-but-wrap left relative">
															<span class="mvp-cont-read-but"><?php esc_html_e( 'Continuer à lire', 'zox-news' ); ?></span>
													...
													<?php $mvp_related = get_option('mvp_related_posts'); if ($mvp_related == "true") { ?>
														<div id="mvp-related-posts" class="left relative">
															<h4 class="mvp-widget-home-title">
																<span class="mvp-widget-home-title"><?php esc_html_e( 'Vous pourriez aimer', 'zox-news' ); ?></span>
															</h4>
													...
													<?php if ( comments_open() ) { ?>
														<?php $disqus_id = get_option('mvp_disqus_id'); if ($disqus_id) { if (isset($disqus_id)) {  ?>
															<div id="mvp-comments-button" class="left relative mvp-com-click">
																<span class="mvp-comment-but-text"><?php comments_number(__( 'Commentaires', 'zox-news'), esc_html__('Commentaires', 'zox-news'), esc_html__('Commentaires', 'zox-news')); ?></span>
															</div><!--mvp-comments-button-->
															<?php $disqus_id2 = esc_html($disqus_id); mvp_disqus_embed($disqus_id2); ?>
														<?php } } else { ?>
															<div id="mvp-comments-button" class="left relative mvp-com-click">
																<span class="mvp-comment-but-text"><?php comments_number(__( 'Cliquer pour commenter', 'zox-news'), esc_html__('1 Commentaire', 'zox-news'), esc_html__('% Commentaires', 'zox-news'));?></span>
															</div><!--mvp-comments-button-->
											...
											<div class="mvp-post-add-head left relative">
												...
												<?php $author_info = get_option('mvp_author_info'); if ($author_info == "true") { ?>
													<div class="mvp-author-info-wrap left relative">
														...
														<div class="mvp-author-info-text left relative">
															<div class="mvp-author-info-date left relative">
																<p><?php esc_html_e( 'Publié', 'zox-news' ); ?></p> <span class="mvp-post-date"><?php printf( esc_html__( 'il y a %s', 'zox-news' ), human_time_diff( strtotime('2 hours', (int)get_the_time('U')), current_time( 'timestamp' ) ) ); ?></span> <p><?php esc_html_e( 'le', 'zox-news' ); ?></p> <span class="mvp-post-date"><?php the_time(get_option('date_format')); ?></span>
															</div><!--mvp-author-info-date-->
											...
											<div class="mvp-post-add-body left relative">
												...
												<div class="mvp-post-add-cont left relative">
													...
													<div class="mvp-post-add-link">
														<a href="<?php the_permalink(); ?>" rel="bookmark"><span class="mvp-post-add-link-but"><?php esc_html_e( "Continuer à lire", 'zox-news' ); ?></span></a>
						...
						<?php global $post; $mvp_trend_post_num = get_option('mvp_trend_post_num'); $pop_days = esc_html(get_option('mvp_pop_days')); $popular_days_ago = "$pop_days days ago"; $recent = new WP_Query(array('posts_per_page' => $mvp_trend_post_num, 'ignore_sticky_posts'=> 1, 'post__not_in' => array( $post->ID ), 'orderby' => 'meta_value_num', 'order' => 'DESC', 'meta_key' => 'post_views_count', 'date_query' => array( array( 'after' => $popular_days_ago )) )); while($recent->have_posts()) : $recent->the_post(); ?>
							...
							<li>
								...
								<div class="mvp-post-more-text left relative">
									<div class="mvp-cat-date-wrap left relative">
										<span class="mvp-cd-cat left relative"><?php $category = get_the_category(); echo esc_html( $category[0]->cat_name ); ?></span><span class="mvp-cd-date left relative"><?php printf( esc_html__( '%s ago', 'zox-news' ), human_time_diff( strtotime('2 hours', (int)get_the_time('U')), current_time( 'timestamp' ) ) ); ?></span>
									</div><!--mvp-cat-date-wrap-->
									<p><?php the_title(); ?></p>
