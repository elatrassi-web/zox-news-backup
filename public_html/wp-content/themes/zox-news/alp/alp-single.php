                    ...
                    <div id="mvp-article-cont" class="left relative">
                        <div id="mvp-post-main" class="left relative">
                            <header id="mvp-post-head" class="left relative">
                                ...
                                <div class="pub-151" style="clear:both;" >
                                    <div id="div-gpt-ad-151" class="lazyload-rwad" data-sticky="true" data-position-mobile="151" data-expand="90000"></div>
                                </div>
                                <?php if ( has_excerpt() ) { ?>
                                            ...
                                            <?php if ( comments_open() ) { ?>
                                                ...
                                                <?php } } else { ?>
                                                    ...
                                                    <div id="mvp-comments-button" class="left relative mvp-com-click-<?php echo esc_html($mvp_click_id); ?> mvp-com-but-<?php echo esc_html($mvp_click_id); ?>">
                                                        <span class="mvp-comment-but-text"><?php comments_number(__( 'Cliquer pour commmenter', 'zox-news'), esc_html__('1 Commentaire', 'zox-news'), esc_html__('% Commentaires', 'zox-news'));?></span>
                                                    </div><!--mvp-comments-button-->
