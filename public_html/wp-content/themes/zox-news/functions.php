...
add_action( 'amp_post_template_head', 'ws_amp_add_pixel' );

function ws_amp_add_pixel( $amp_template ) {
    $post_id = $amp_template->get( 'post_id' );
    ?>
    <amp-pixel src="https://www.wysistat.com/images/myangers_amp/compteur_amp.php?nom=myangers_amp&id_int=CLIENT_ID(cid-ws-amp)&page_js=SOURCE_URL"></amp-pixel>
    <?php
}
...
function mvp_scripts_method() {
	...
	wp_enqueue_style( 'mvp-pub-fix', get_template_directory_uri() . '/css/pub-fix.css', [], '1.0');
	wp_enqueue_style( 'mvp-style-fix', get_template_directory_uri() . '/css/style-fix.css', [], '1.0');
