		...
		<section id="mvp-feat1-wrap" class="left relative">
			<div class="mvp-feat1-right-out left relative">
					...
					<div class="mvp-feat1-main left relative">
						<div class="mvp-feat1-left-wrap relative">
							...
							<div class="mvp-feat1-sub-wrap left relative">
								<?php global $do_not_duplicate; global $post; $recent = new WP_Query(array( 'tag' => get_option('mvp_feat_posts_tags'), 'post__not_in'=>$do_not_duplicate, 'posts_per_page' => '2', 'ignore_sticky_posts'=> 1  )); 
									$j = 0;
						...
						<div class="mvp-feat1-mid-wrap left relative">
							...
							<div class="pub left center relative w100">
								<div id="div-gpt-ad-3" class="lazyload-rwad" data-position-desktop="3" ></div>
							</div>
							...
							<div class="mvp-feat1-pop-wrap left relative">
								<?php 
									global $do_not_duplicate; global $post; $pop_days = esc_html(get_option('mvp_pop_days')); $popular_days_ago = "$pop_days days ago"; $recent = new WP_Query(array('posts_per_page' => '5', 'ignore_sticky_posts'=> 1, 'tag__not_in' => array(3488), 'post__not_in' => $do_not_duplicate, 'orderby' => 'meta_value_num', 'order' => 'DESC', 'meta_key' => 'post_views_count', 'date_query' => array( array( 'after' => $popular_days_ago )) )); while($recent->have_posts()) : $recent->the_post(); ?>
									<a href="<?php the_permalink(); ?>" rel="bookmark">
				...
				<div class="mvp-feat1-right-wrap left relative">
					...
					<div class="pub right center relative w100">
						<div id="div-gpt-ad-mpu_haut" class="dfp_pub"></div>
					...
					<div class="mvp-feat1-list-wrap left relative">
						<div class="mvp-feat1-list-head-wrap left relative">
							<ul class="mvp-feat1-list-buts left relative">
								<li class="mvp-feat-col-tab"><a href="#mvp-feat-tab-col1"><span class="mvp-feat1-list-but"><?php esc_html_e( 'Les + récents', 'zox-news' ); ?></span></a></li>
								<?php query_posts(array( 'tax_query' => array( array( 'taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-video' )) )); if (have_posts()) : ?>
									<li><a href="#mvp-feat-tab-col2"><span class="mvp-feat1-list-but"><?php esc_html_e( 'Vidéos', 'zox-news' ); ?></span></a></li>
								<?php endif; wp_reset_query(); ?>
								<?php query_posts(array( 'tax_query' => array( array( 'taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-gallery' )) )); if (have_posts()) : ?>
									<li><a href="#mvp-feat-tab-col3"><span class="mvp-feat1-list-but"><?php esc_html_e( 'Images', 'zox-news' ); ?></span></a></li>
								<?php endif; wp_reset_query(); ?>
							</ul>
				...
				<div class="mvp-feat5-side-in">
					<div class="mvp-feat5-main-wrap left relative">
						...
						<div class="mvp-feat5-small-wrap left relative">
							<h3 class="mvp-feat1-pop-head"><span class="mvp-feat1-pop-head"><?php esc_html_e( 'Nouveau', 'zox-news' ); ?></span></h3>
