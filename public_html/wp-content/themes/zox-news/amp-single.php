...
<div id="mvp-site" class="left relative">
    <div id="mvp-site-wall" class="left relative">
        <div id="mvp-site-main" class="left relative">
                                                    ...
                                                    <div class="mvp-post-more-text left relative">
                                                        <a href="<?php the_permalink(); ?>" rel="bookmark">
                                                            <div class="mvp-cat-date-wrap left relative">
                                                                <span class="mvp-cd-cat left relative"><?php $category = get_the_category(); echo esc_html( $category[0]->cat_name ); ?></span><span class="mvp-cd-date left relative"><?php printf( esc_html__( 'il y a %s', 'zox-news' ), human_time_diff( strtotime('2 hours', (int)get_the_time('U')), current_time( 'timestamp' ) ) ); ?></span>
            ...
            <footer class="ai-amp-footer">
                <div class="ai-amp-container">
                    <div class="ai-amp-logo">
                        <amp-img src="https://my-angers.info/wp-content/uploads/2026/02/logo-angers-info-responsive.png" width="150" height="50" layout="fixed"></amp-img>
                    </div>
                    <div class="ai-amp-social">
                        <amp-social-share type="facebook" width="35" height="35"></amp-social-share>
                        <amp-social-share type="twitter" width="35" height="35"></amp-social-share>
                    </div>
                </div>
                <div class="ai-amp-orange-bar">
                    © <?php echo date('Y'); ?> Angers Info
                </div>
            </footer>
        </div><!--mvp-site-main-->
    </div><!--mvp-site-wall-->
