...
<head>
    <script type="text/javascript" src="https://cache.consentframework.com/js/pa/29592/c/Nq5eV/stub" referrerpolicy="unsafe-url" charset="utf-8"></script>
    <script>
        window.Sddan = {
            "info": {
                "hd_m" : "",
    ...
    <script type="text/javascript" src="https://choices.consentframework.com/js/pa/29592/c/Nq5eV/cmp" referrerpolicy="unsafe-url" charset="utf-8" async></script>
    ...
    <?php } ?>
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-167215528-1"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'UA-167215528-1');
        </script>
...
<body <?php body_class(''); ?>>
<amp-auto-ads type = "adsense" data-ad-client = "ca-pub-3938520540785238"> </ amp-auto-ads>
<script>
                                            ...
                                            <div class="mvp-nav-top-cont left relative">
                                                <div class="mvp-nav-top-left-out relative">
                                                    <div class="mvp-nav-top-left">
                                                        <div class="mvp-nav-soc-wrap" style="position: relative; z-index: 9999;">
                                                            <?php if(get_option('mvp_facebook')) { ?>
                                                                <a href="<?php echo esc_url(get_option('mvp_facebook')); ?>" target="_blank"><span class="mvp-nav-soc-but fa fa-facebook fa-2"></span></a>
                                                            <?php } ?>
                                                            <?php if(get_option('mvp_twitter')) { ?>
                                                                <a href="<?php echo esc_url(get_option('mvp_twitter')); ?>" target="_blank"><span class="mvp-nav-soc-but fa-brands fa-x-twitter fa-2"></span></a>
                                                            <?php } ?>
                                                            <?php if(get_option('mvp_pinterest')) { ?>
                                                                <a href="<?php echo esc_url(get_option('mvp_pinterest')); ?>" target="_blank"><span class="mvp-nav-soc-but fa-brands fa-tiktok fa-2"></span></a>
                                                            <?php } ?>
                                                            <?php if(get_option('mvp_instagram')) { ?>
                                                                <a href="<?php echo esc_url(get_option('mvp_instagram')); ?>" target="_blank"><span class="mvp-nav-soc-but fa fa-instagram fa-2"></span></a>
                                                            <?php } ?>
                                                            <?php if(get_option('mvp_youtube')) { ?>
                                                                <a href="<?php echo esc_url(get_option('mvp_youtube')); ?>" target="_blank"><span class="mvp-nav-soc-but fa fa-youtube-play fa-2"></span></a>
                                                            <?php } ?>
                                                        </div>
                                                        <div class="mvp-fly-but-wrap mvp-fly-but-click left relative">
                                                            <span></span>
                                                    ...
                                                    <div class="mvp-nav-top-left-in">
                                                        <div class="mvp-nav-top-mid left relative" itemscope itemtype="http://schema.org/Organization">
                                                            ...
                                                            <?php } ?>
                                                            <?php if(get_option('mvp_logo_nav')) { ?>
                                                            <a class="mvp-nav-logo-small" href="<?php echo esc_url( home_url( '/' ) ); ?>">
                                                                <img src="https://my-angers.info/wp-content/uploads/2019/08/logo-angers-info-bloc800px.jpg"
                                        ...
                                        <div class="mvp-nav-top-right">
                                            <?php if ( class_exists( 'WooCommerce' ) ) { ?>
                                                <div class="mvp-woo-cart-wrap">
                                                    <a class="mvp-woo-cart" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_html_e( 'Voir sa carte de shopping', 'zox-news' ); ?>"><span class="mvp-woo-cart-num"><?php echo WC()->cart->get_cart_contents_count(); ?></span></a><span class="mvp-woo-cart-icon fa fa-shopping-cart" aria-hidden="true"></span>
